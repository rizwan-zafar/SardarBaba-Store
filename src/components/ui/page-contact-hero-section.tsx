    ...
    >
      <div className="w-full max-w-[1484px] mx-auto px-4 md:px-6 lg:px-8">
        <div className="sm:max-w-xs md:max-w-sm lg:max-w-xl lg:pb-5">
          <h2 className="font-manrope font-extrabold text-xl leading-7 md:leading-snug lg:leading-snug sm:text-2xl md:text-3xl lg:text-4xl 3xl:text-5xl 3xl:leading-snug text-brand-light tracking-tight mb-2.5 md:ltr:pr-6 md:rtl:pl-6 lg:ltr:pr-36 lg:rtl:pl-36 3xl:ltr:pr-0 3xl:rtl:pl-0">
            {t(heroTitle)}
          </h2>
          <p className="text-15px lg:text-base xl:text-[17px] leading-7 lg:leading-8 xl:leading-9 text-brand-light text-opacity-60 lg:ltr:pr-28 lg:rtl:pl-28">
            {t(heroDescription)}
          </p>
        </div>
      </div>
