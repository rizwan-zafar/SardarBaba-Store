...
export const homeSixHeroBanner = {
  id: 1,
  title: 'Stationary at Door Step ? YESSS',
  description: 'At your doorstep, SardarBaba offers every form of stationary. Place your order today to receive your stationary',
  searchBox: true,
  image: {
    mobile: {
      url: 'https://thumbs.dreamstime.com/b/set-different-stationery-alarm-clock-colorful-supplies-blue-background-back-to-school-concept-banner-format-top-view-set-153945404.jpg',
    },
    desktop: {
      url: 'https://thumbs.dreamstime.com/b/set-different-stationery-alarm-clock-colorful-supplies-blue-background-back-to-school-concept-banner-format-top-view-set-153945404.jpg',
    },
...
export const homeSixBanner = {
  ...
  image: {
    mobile: {
      url: '/assets/images/banner/sardarBanner.jpg',
      width: 450,
      height: 400,
    },
    desktop: {
